        ...
        <div className="home-item-wrapper">
          ...
          <div className="item-wrapper">
            ...
            >
              ...
              <div className="item-title">{t("titleone")}</div>
              <div className="item-desc">{t("descone")}</div>
            </div>
            <div
              className="item"
              data-aos="fade-down"
            ...
            >
              ...
              <div className="item-desc">{t("desctwo")}</div>
            </div>
            <div
              className="item"
              data-aos="fade-down"
            ...
            >
              ...
              <div className="item-desc">{t("descthree")}</div>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="guy-item-wrapper">
          ...
          <div className="item-wrapper-two">
            ...
            >
              ...
              <div className="item-desc"> {t("descfour")}</div>
            </div>
            <div
              className="itemtwo"
              data-aos="fade-down"
            ...
            >
              ...
              <div className="item-desc"> {t("descfive")}</div>
            </div>
            <div
              className="itemtwo"
              data-aos="fade-down"
            ...
            >
              ...
              <div className="item-desc"> {t("descsix")}</div>
            </div>
            <div
              className="itemtwo"
              data-aos="fade-down"
            ...
            >
              ...
              <div className="item-desc"> {t("descseven")}</div>
            </div>
          </div>
          <Image
            className="guy-img"
        ...
        <div className="home-item-wrapper">
          ...
          <div className="item-wrapper">
            ...
            >
              ...
              <div className="item-desc">{t("desceight")} </div>
            </div>
            <div
              className="item"
              data-aos="fade-down"
            ...
            >
              ...
              <div className="item-desc">{t("descnine")} </div>
            </div>
            <div
              className="item"
              data-aos-once="true"
            ...
            >
              ...
              <div className="item-desc">{t("descten")} </div>
            </div>
            <div
              className="item"
              data-aos-once="true"
            ...
            >
              ...
              <div className="item-desc">{t("descel")} </div>
            </div>
          </div>
        </div>
      </div>
